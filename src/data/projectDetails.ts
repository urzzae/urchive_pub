...
export const projectDetails: ProjectDetail[] = [
  {
    ...
    tags: ["Photoshop", "Html", "CSS", "jQuery", "Web & Mobile"],
    contribution: "개인작업 기여도 : 100%",
    description:
      "국립중앙도서관 웹사이트를 개인 포트폴리오용으로 리디자인한 사이드 프로젝트입니다.\n사용자 관점에서 주요 서비스의 접근성과 중요도를 고려하여 메인 콘텐츠를 재구성했습니다.",
    buttons: [
  ...
  },
  {
    ...
    contribution: "개인작업 기여도 : 100%",
    description:
      "책발전소의 라이프스타일 브랜드 '브론테' 쇼핑몰을 개인 포트폴리오용으로 감성적으로 리디자인한 사이드 프로젝트입니다.\n인터랙션과 동적 모션으로 사용자 경험을 높이고, Swiper를 활용해 다양한 형태의 슬라이드를 구현하였습니다.\n각 페이지는 목적에 맞게 구조를 설계하고, 전 페이지를 반응형 웹으로 구현했습니다.",
    buttons: [
      {
        label: "전체페이지 결과물",
  ...
  },
  {
    ...
    tags: ["Photoshop", "Figma", "Html", "CSS", "jQuery", "Web & Mobile"],
  ...
  },
  {
    ...
    contribution: "기획&디자인 기여도 : 80% / 퍼블리싱 기여도 : 100%",
    description:
