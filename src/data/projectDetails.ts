...
export const projectDetails: ProjectDetail[] = [
  ...
  },
  {
    ...
    contribution: "개인작업 기여도 : 100%",
    description:
      "책발전소의 라이프스타일 브랜드 '브론테' 쇼핑몰을 개인 포트폴리오용으로 감성적으로 리디자인한 사이드 프로젝트입니다.\nSwiper를 활용한 다양한 형태의 슬라이드와 스크롤 관련 라이브러리 기반 인터랙션을 통해 사용자 경험을 높였습니다.",
    buttons: [
      {
        label: "전체페이지 결과물",
